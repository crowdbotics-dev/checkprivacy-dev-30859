...
## Project Structure
    ...
    ├── checkprivacy_dev_30859  # Django project configurations
...
1. Clone this repo and `cd checkprivacy_dev_30859`
...
2. Clone this repo and `cd checkprivacy_dev_30859`
